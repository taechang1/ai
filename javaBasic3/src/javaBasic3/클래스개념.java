...
public class 클래스개념 {
	...
	public static void main(String[]args) {
		...
		Teacher ti=new Teacher("A32","정현희","컴공",10000,"전임",20);
		//"230101"
		System.out.println(st1.get학번());
		//AI
		System.out.println(st1.get점수());
		//정현희
		System.out.println(ti.get이름());
		//전임
		System.out.println(ti.get구분());
		System.out.println(st1.get점수());
		System.out.println(ti.get시수());
		//필요할때마다 넣기
		//빈객체 생성하기
		...
		//생성자로 값을 넣기
		자동차판매현황 car1=new 자동차판매현황("싼타패",35000000,15000000,2000000,36,555555);
		//빈 객체를 생성하기
		...
		System.out.println(car1.get차량명()+" "+car1.get차량총액()+" "+car1.get인도금()+" "+car1.get할부원금());
		System.out.println(car2.get차량명()+" "+car2.get차량총액()+" "+car2.get인도금()+" "+car2.get할부원금());
