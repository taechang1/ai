...
public class SetEx3 {
	...
	public static void main(String[] args) {
	  ...
	  //이름과 나이가 같으면 같은사람? hashCode() equals()
		//  모두 출력하기
		Iterator<Member>it=mSet.iterator();
		while(it.hasNext()) {
			System.out.println(it.next().toString());
			//주소를 출력하면 자동으로 toString() 이 붙는다
			//toString이  Object클래스의 메소드이다
			//자식인 member에서 tostring재정의하면 자식 메소드로 반영된다
		}
...
class Member{
	...
	//동등객체를 사용자 정의(개발자가 정의 하려면 hashCode()와 equals() 재정의해야한다
	@Override
	public int hashCode() {
		// TODO Auto-generated method stub
		Integer ageI =Integer.valueOf(age);//기본형 int age를 클래스형 integer바꿈
