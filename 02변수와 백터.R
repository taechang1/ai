...
num2<-200:500
num2
#100~300,400~500 까지벡터 만들기
num3<-c(100:300,400:500)
num3
# 1 3 5 7 9 .. 99까지 벡터 만들기 1~100까지 증가치 2인 벡터 
만들기
#도움말 help(함수명)
help(seq)
seq(from=1,to=100,by=2)#정식 형식
seq(1,100,2)#약식
#99 97 ..1 까지 벡터 만들기
...
my.info$status
my.info[[3]]
#factor 범주형 자료(ex동서남북,)저장 사용한다
bt<-c('A','B','B','O','AB')#vector 만듬
bt.new<-factor(bt)
bt.new
bt.new[1:3]
bt.new[-2]#2번째 인덱스값 제외하고 보여줌
levels(bt.new)
as.integer(bt.new)
bt.new[6]
bt.new
...
people
#12
a<-c('korea','japan','China','indoea','korea','China')
f<-factor(a)
f
f[4]
levels(f)#4
